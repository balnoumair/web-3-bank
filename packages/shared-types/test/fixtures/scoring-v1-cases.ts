...
export const SCORING_V1_CASES: ScoringV1Case[] = [
  {
  ...
  {
    id: "score-and-reliability-tie-resolved-by-latency",
    scenario: "normal",
    metrics: [
      {
        chain: "atlas-sepolia",
    ...
    expected: {
      recommendedChain: "nova-sepolia",
      ranked: [
        { chain: "nova-sepolia", score: 0.65 },
        { chain: "atlas-sepolia", score: 0.65 },
        { chain: "zenith-sepolia", score: 0.325 },
      ],
      reasonCodes: ["SCENARIO_NORMAL", "TIE_BREAK_LATENCY"],
    },
  },
  {
    id: "full-tie-resolved-by-chain-lex-order",
    scenario: "normal",
    metrics: [
      {
        chain: "avalanche-sepolia",
        feeRaw: 10,
        latencyRaw: 200,
        reliabilityRaw: 0.95,
        liquidityRaw: 0.8,
    ...
    expected: {
      recommendedChain: "avalanche-sepolia",
      ranked: [
        { chain: "avalanche-sepolia", score: 1 },
        { chain: "base-sepolia", score: 1 },
        { chain: "zora-sepolia", score: 0 },
      ],
      reasonCodes: ["SCENARIO_NORMAL", "TIE_BREAK_CHAIN"],
    },
  },
  {
  ...
  {
    id: "single-chain-is-deterministic",
    scenario: "congested",
    metrics: [
      {
        chain: "base-sepolia",
    ...
    expected: {
      recommendedChain: "base-sepolia",
      ranked: [{ chain: "base-sepolia", score: 1 }],
      reasonCodes: [
        "SCENARIO_CONGESTED",
        "ZERO_RANGE_FEE_RAW",
