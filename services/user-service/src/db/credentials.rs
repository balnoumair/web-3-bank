...
mod tests {
    ...
    async fn test_duplicate_address_rejected(pool: PgPool) {
        ...
        cred_repo
            .insert(user_id, b"cred-1", b"pk", &a)
            .await
            .unwrap();
        let err = cred_repo
            .insert(user_id, b"cred-2", b"pk", &a)
            .await
            .unwrap_err();
    ...
    async fn test_list_credentials_active_only(pool: PgPool) {
        ...
        cred_repo
            .insert(
                ...
                b"cred1",
                b"pk1",
                &addr("0xaaaa111111111111111111111111111111111111"),
            )
            .await
            .unwrap();
        cred_repo
            .insert(
                ...
                b"cred2",
                b"pk2",
                &addr("0xbbbb222222222222222222222222222222222222"),
            )
            .await
            .unwrap();
    ...
    async fn test_revoke_last_credential_fails(pool: PgPool) {
        ...
        cred_repo
            .insert(
                ...
                b"only-cred",
                b"pk",
                &addr("0xcccc333333333333333333333333333333333333"),
            )
            .await
            .unwrap();
